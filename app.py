...
import pandas as pd
from pycaret.regression import setup as reg_setup, compare_models as reg_compare, evaluate_model as reg_evaluate, predict_model as reg_predict
from pycaret.classification import setup as clf_setup, compare_models as clf_compare, evaluate_model as clf_evaluate, predict_model as clf_predict
...
try:
    if problem_type == "Regression":
        ...
        st.write(metrics)  # Displays summary table of model metrics
